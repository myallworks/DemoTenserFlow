...
public class BirdAudioClassificationActivity extends AudioHelperActivity {
    ...
    public void startRec(View view) {
        ...
        timeTask = new TimerTask() {
            ...
            public void run() {
                ...
                for (Category category : outputLst.get(0).getCategories()) {
                ...
                for (Category category : outputLst.get(1).getCategories()) {
