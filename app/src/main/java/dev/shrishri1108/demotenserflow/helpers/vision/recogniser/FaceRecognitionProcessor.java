package dev.shrishri1108.demotenserflow.helpers.vision.recogniser;
...
import dev.shrishri1108.demotenserflow.RealTimeFaceDetectorActivity;
import dev.shrishri1108.demotenserflow.helpers.vision.FaceGraphic;
import dev.shrishri1108.demotenserflow.helpers.vision.GraphicOverlay;
...
public class FaceRecognitionProcessor extends VisionBaseProcessor<List<Face>> {
    ...
    public RealTimeFaceDetectorActivity activity;
...
//                            }
                            ...
                            graphicOverlay.add(faceGraphic);
                                ...
                                ex.printStackTrace();
                                Log.e(Constant.TAG, "onSuccess: ", ex);
                            }
                        }
                    }
                })
